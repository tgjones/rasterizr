...
namespace SlimShader.Parser.Opcodes.Declarations
{
	...
	/// </summary>
	public class ConstantBufferDeclarationParser : BytecodeParser<ConstantBufferDeclarationToken>
	{
		public ConstantBufferDeclarationParser(BytecodeReader reader)
			: base(reader)
		{
			
		}

		public override ConstantBufferDeclarationToken Parse()
		{
