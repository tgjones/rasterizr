	...
	public class AffineTextureMappingScene : PresetSceneBase
	{
		public override void Draw(RasterizrDevice device)
		{
			...
			device.InputAssembler.Vertices = new[]
			{
				...
				new VertexPositionColorTexture(new Point3D(-1, 1, -2f), ColorsF.White, new Point2D(1, 0)),
				new VertexPositionColorTexture(new Point3D(1, 1, -2f), ColorsF.White, new Point2D(1, 1))
			};
